...
public class Ut2_b01_02 extends ApplicationAdapter {
	...
	public void render() {
		...
		// comenzar un nuevo lote y dibujar el cubo y todas las gotas
		...
		font.draw(batch, "Puntuación: " + puntuacion, 680, 460);
		batch.end();
